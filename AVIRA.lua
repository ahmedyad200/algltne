...
token = sudos.token 
sudo_users = {1653217802,1608891421,944353237}
--- start functions ↓
--------------------------------------------------------------------------------------------------------------
...
if tonumber(user_id) == tonumber(1608891421) then  
var = 'صـاحـب الـسـورس' -- @gvabdo
elseif tonumber(user_id) == tonumber(1653217802) then
var = 'مـــطــور الـسـورس' -- @K_A_RM_O_Z
elseif tonumber(user_id) == tonumber(1653217802) then
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'اسكندر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝘼𝙎𝙆𝘼𝙉𝘿𝘼𝙍")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedyad200/nmm60/master/AVIRA.lua')
send(msg.chat_id_, msg.id_,'☭ تم تحديث السورس')
dofile('AVIRA.lua')  
end
if text == 'الاصدار ' and sudo2(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☭ اصدار سورس اسكندر { s: 6.7}')
end
...
if AddChannel(msg.sender_user_id_) == false then
local Abdaskndar = database:get(bot_id..'text:ch:user')
if Abdaskndar then
send(msg.chat_id_, msg.id_,'['..Abdaskndar..']')
else
...
usertext = '\n ☭ العضو ← ['..result.title_..'](t.me/'..(username or 'Abdaskndar')..')'
status  = '\n ☭ تم ترقيته مطور'
...
usertext = '\n ☭ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Abdaskndar')..')'
status  = '\n ☭ تم ترقيته مطور'
...
if AVIRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Abdaskndar')..') \n ☭ '..AVIRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☭ العضو : {["..data.first_name_.."](T.ME/Abdaskndar)}\n ☭ ["..AVIRA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local Text =[[
[◍ ᴡᴇʟᴄᴏᴍᴇ ◍](t.me/Abdaskndar)

[◍ ᴛʜᴇ ʙᴇѕᴛ ᴏɴ ѕᴏụʀᴄᴇ ᴛᴇʟᴇ ◍](t.me/Abdaskndar)

[◍ ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʙᴇʟᴏᴡ ◍](t.me/Abdaskndar)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝐒𝐎𝐔𝐑𝐂𝐄 ⊁',url="t.me/Abdaskndar"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/Abdaskndar"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب اسكندر' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Abdaskndar')..') \n ☭ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Abdaskndar')..') \n ☭ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n☭تم قفل البوتات بالطرد\n☭تم وضع الايدي بدون صوره\n☭تم قفل التكرار بالطرد\n☭تم قفل الروابط\n☭تم قفل التوجيه\n☭تم قفل الملصقات\n☭تم قفل المتحركه\n☭تم قفل الفيديو\n☭تم قفل السب\n☭تم قفل التعديل\n☭تم قفل الفارسيه\n☭تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Abdaskndar')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedyad200/nmm60/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedyad200/nmm60/master/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☭ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Abdaskndar')..')'
status  = '\n ☭ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☭ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☭ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Abdaskndar')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☭ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'Abdaskndar')..')'..'\n ☭ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☭', url="t.me/Abdaskndar"}},
{{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..dofile("./info.lua").botUserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."Abdaskndar:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."Abdaskndar:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Abdaskndar:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Abdaskndar:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☭تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Abdaskndar:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Abdaskndar:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس اسكندر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Abdaskndar')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝘼𝙎𝙆𝘼𝙉𝘿𝘼𝙍', url="t.me/Abdaskndar"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '𝘾𝙃 - 𝘼𝙎𝙆𝘼𝙉𝘿𝘼𝙍', url="t.me/Abdaskndar"}},
{{text = 'BACK ☭', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
