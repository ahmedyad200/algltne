...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'كلاسيك'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "XXx_cLASsIC_xXX")
...
Namebot = (database:get(bot_id..'Name:Bot') or 'كلاسيك')
...
send(msg.chat_id_, msg.id_,' ☭ اصدار سورس كلاسيك { s: 6.7}')
end
...
usertext = '\n ☭ العضو ← ['..result.title_..'](t.me/'..(username or 'XXx_cLASsIC_xXX')..')'
status  = '\n ☭ تم ترقيته مطور'
...
usertext = '\n ☭ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'XXx_cLASsIC_xXX')..')'
status  = '\n ☭ تم ترقيته مطور'
...
if AVIRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XXx_cLASsIC_xXX')..') \n ☭ '..AVIRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☭ العضو : {["..data.first_name_.."](T.ME/XXx_cLASsIC_xXX)}\n ☭ ["..AVIRA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☭ عذرا ← {["..data.first_name_.."](T.ME/XXx_cLASsIC_xXX)}\n ☭ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس كلاسيك ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس كلاسيك ؟ ", 
"كم مره حبيت؟ ", 
...
local Text =[[
[◍ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴄʟαѕѕᎥᴄ  ◍](t.me/XXx_cLASsIC_xXX)

[◍ ᴛʜᴇ ʙᴇѕᴛ ᴏɴ ѕᴏụʀᴄᴇ ᴛᴇʟᴇ ◍](t.me/XXx_cLASsIC_xXX)

[◍ ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʙᴇʟᴏᴡ ◍](t.me/XXx_cLASsIC_xXX)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝐒𝐎𝐔𝐑𝐂𝐄 ⊁',url="t.me/XXx_cLASsIC_xXX"}},
...
local Text = [[ 
[CH](t.me/XXx_cLASsIC_xXX)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/XXx_cLASsIC_xXX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸' then
local Text = [[ 
☭من أحسن السورسات على التليجرام سورس كلاسيك☭
...
if text == 'العاب كلاسيك' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ☭ اهلا في قائمه الالعاب المتطوره سورس كلاسيك  ☭ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XXx_cLASsIC_xXX')..') \n ☭ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'XXx_cLASsIC_xXX')..') \n ☭ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n☭تم قفل البوتات بالطرد\n☭تم وضع الايدي بدون صوره\n☭تم قفل التكرار بالطرد\n☭تم قفل الروابط\n☭تم قفل التوجيه\n☭تم قفل الملصقات\n☭تم قفل المتحركه\n☭تم قفل الفيديو\n☭تم قفل السب\n☭تم قفل التعديل\n☭تم قفل الفارسيه\n☭تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XXx_cLASsIC_xXX')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if text == ("مسح قائمه كلاسيك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☭ تم مسح قائمه كلاسيك')
return false
end

if text == 'قائمه كلاسيك' and Sudo(msg) then
...
if text == ("رفع كلاسيك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local XXx_cLASsIC_xXX = database:get(bot_id..'text:ch:user')
if XXx_cLASsIC_xXX then
send(msg.chat_id_, msg.id_,'['..XXx_cLASsIC_xXX..']')
...
if text and text:match("^رفع كلاسيك @(.*)$") and Sudo(msg) then
local username = text:match("^رفع كلاسيك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local XXx_cLASsIC_xXX = database:get(bot_id..'text:ch:user')
if XXx_cLASsIC_xXX then
send(msg.chat_id_, msg.id_,'['..XXx_cLASsIC_xXX..']')
...
if text and text:match("^رفع كلاسيك (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع كلاسيك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local XXx_cLASsIC_xXX = database:get(bot_id..'text:ch:user')
if XXx_cLASsIC_xXX then
send(msg.chat_id_, msg.id_,'['..XXx_cLASsIC_xXX..']')
...
if text == ("تنزيل كلاسيك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local XXx_cLASsIC_xXX = database:get(bot_id..'text:ch:user')
if XXx_cLASsIC_xXX then
send(msg.chat_id_, msg.id_,'['..XXx_cLASsIC_xXX..']')
...
if text and text:match("^تنزيل كلاسيك @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل كلاسيك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local XXx_cLASsIC_xXX = database:get(bot_id..'text:ch:user')
if XXx_cLASsIC_xXX then
send(msg.chat_id_, msg.id_,'['..XXx_cLASsIC_xXX..']')
...
if text and text:match("^تنزيل كلاسيك (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل كلاسيك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local XXx_cLASsIC_xXX = database:get(bot_id..'text:ch:user')
if XXx_cLASsIC_xXX then
send(msg.chat_id_, msg.id_,'['..XXx_cLASsIC_xXX..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☭ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'XXx_cLASsIC_xXX')..')'
status  = '\n ☭ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☭ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☭ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'XXx_cLASsIC_xXX')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☭ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'XXx_cLASsIC_xXX')..')'..'\n ☭ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☭', url="t.me/XXx_cLASsIC_xXX"}},
{{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..dofile("./info.lua").botUserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."XXx_cLASsIC_xXX:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."XXx_cLASsIC_xXX:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."XXx_cLASsIC_xXX:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."XXx_cLASsIC_xXX:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☭تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."XXx_cLASsIC_xXX:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."XXx_cLASsIC_xXX:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس كلاسيك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كلاسيك').." غادر" or text == 'غادر' then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كلاسيك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كلاسيك')
local AVIRA_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
...
if text == "بوت" then 
local Namebot = (database:get(bot_id..'Name:Bot') or 'كلاسيك') 
local DRAGON_Msg = { 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XXx_cLASsIC_xXX')..')'
local iduser = result.sender_user_id_
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '𝘾𝙃 - 𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐋𝐀𝐒𝐒𝐈𝐊', url="t.me/XXx_cLASsIC_xXX"}},
{{text = 'BACK ☭', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كلاسيك')
